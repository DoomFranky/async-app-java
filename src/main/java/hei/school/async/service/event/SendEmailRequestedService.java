...
public class SendEmailRequestedService implements Consumer<SendEmailRequested> {
    ...
    public void accept(SendEmailRequested sendEmailRequested) {
        ...
        InternetAddress recipientAddress = new InternetAddress(sendEmailRequested.getImageDTO().getEmail());
        String htmlResponse = """
                <!DOCTYPE html>
                <html lang="fr">
                <head>
        ...
        mailer.accept(new Email(recipientAddress, List.of(), List.of(), "Image in black and white", htmlResponse, List.of()));
    }
}